...
const indicatorRequestService_1 = require("../service/indicatorRequestService");
...
class IndicatorRequestController {
    constructor() {
        ...
        this.indicatorRequestService = new indicatorRequestService_1.IndicatorRequestService();
    }
    verifyApiKey(apiKey) {
        try {
